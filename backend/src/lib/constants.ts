...
export const VALIDATION_MESSAGES = {
  ...
  PHONE_INVALID_FORMAT:
    "Phone number must be 10 to 15 digits (e.g., +1234567890)",
  ...
  TITLE_INVALID_CHARS:
    "Title contains invalid characters (HTML tags are not allowed)",
  BODY_REQUIRED: "Post body is required",
  BODY_MIN_LENGTH: "Post body must be at least 1 character long",
  BODY_INVALID_CHARS:
    "Body contains invalid characters (HTML tags are not allowed)",
  ...
  COMMENT_BODY_INVALID_CHARS:
    "Comment body contains invalid characters (HTML tags are not allowed)",
  POST_ID_REQUIRED: "Post ID is required",
