...
export const fetchClient = async (url, options = {}, metadata = {}) => {
  ...
  try {
    ...
    // Merge extra root-level properties into the 'data' payload if it exists and is an object
    // This prevents stripping properties like 'paginationOptions' if the backend puts them at the root
    const mergedData =
